      ...
      `}
        ...
        >
            ...
            <div className="p-4 flex flex-col flex-grow justify-between">
                <div>
                    <h3 className="font-medium text-slate-800 text-lg leading-tight mb-2 line-clamp-2" title={gift.name}>
                        {gift.name}
                    </h3>
                    ...
                    <div className="flex items-baseline gap-1">
                        ...
                        <p className="text-orange-600 font-extrabold text-2xl tracking-tight">
